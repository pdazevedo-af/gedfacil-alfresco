...
This project uses the following specific component versions:

- **PostgreSQL:** 16.5
- **Java:** 17
- **Alfresco Content Services (ACS):** 7.3.x
- **Apache ActiveMQ:** 5.18
- **Alfresco Search Services:** 2.0.15
- **Maven:** 3.9
- **Transform Service AIO:** 3.0.x
- **Spring Boot Out-of-Process SDK:** 5.2
