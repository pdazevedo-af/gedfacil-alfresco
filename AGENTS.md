...
| Spring Boot Out-of-Process SDK | 6.0.0 | External Spring Boot app (compatible with Java 17) |
| Java | 17 | Required by ACS 7.3 |
| Maven | 3.9+ | Build tool |
| Docker Compose | v2 | No `version:` key in compose files |
| PostgreSQL | 14.x | Default database for 7.3 |
| Apache ActiveMQ | 5.17.x | Event messaging |
| Search Services (Solr) | 2.0.x | Community default |
| Transform Service | 3.1.x | AIO (all-in-one) for development |
